  ...
  if (str_detect(final_california_file[i], '04-')) {
    ...
    for (k in 1:length(california_companies)) {
      if (str_detect(california_companies[k], '04-')) {
        ...
        vector_company_copy[3] <- california_companies[k]
      }
        ...
        vector_company_copy[4] <- california_companies[k]
      }
        ...
        vector_company_copy[5] <- california_companies[k]
      }
        ...
        vector_company_copy[6] <- california_companies[k]
      }
    #  break
    }
